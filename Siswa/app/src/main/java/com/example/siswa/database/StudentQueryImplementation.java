    ...
    public void createStudent(Student student, QueryResponse<Boolean> response) {
        ...
        try {
            ...
            if(id>0) {
                ...
                response.onFailure("Gagal membuat data mahasiswa!");
    ...
    public void readStudent(int studentId, QueryResponse<Student> response) {
        ...
        try {
            ...
            if(cursor!=null && cursor.moveToFirst()) {
                ...
                response.onFailure("Tidak menemukan mahasiswa dengan ID ini di database");
    ...
    public void readAllStudent(QueryResponse<List<Student>> response) {
        ...
        try {
            ...
            if(cursor!=null && cursor.moveToFirst()){
                ...
                response.onFailure("Tidak ada data mahasiswa di database");
    ...
    public void updateStudent(Student student, QueryResponse<Boolean> response) {
        ...
        try {
            ...
            if(rowCount>0)
                ...
                response.onFailure("Tidak ada data mahasiswa yang diperbarui");
        } catch (Exception e){
            response.onFailure(e.getMessage());
        } finally {
            sqLiteDatabase.close();
    ...
    public void deleteStudent(int studentId, QueryResponse<Boolean> response) {
        ...
        try {
            ...
            if(rowCount>0)
                ...
                response.onFailure("Gagal menghapus data mahasiswa!");
        } catch (Exception e){
            response.onFailure(e.getMessage());
        } finally {
            sqLiteDatabase.close();
