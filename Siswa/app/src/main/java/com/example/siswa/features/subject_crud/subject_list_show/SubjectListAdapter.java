package com.example.siswa.features.subject_crud.subject_list_show;
...
import com.example.siswa.database.SubjectQueryImplementation;
import com.example.siswa.features.subject_crud.SubjectCrudListener;
import com.example.siswa.features.subject_crud.subject_update.*;
...
public class SubjectListAdapter extends RecyclerView.Adapter<SubjectViewHolder> {
    ...
    private void showConfirmationDialog(final int subjectId) {
        ...
        alertDialogBuilder.setMessage("Ingin menghapus mata kuliah ini?");
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        query.deleteSubject(subjectId, new QueryResponse<Boolean>() {
                            ...
                            public void onSuccess(Boolean data) {
                                ...
                                Toast.makeText(context, "Mata kuliah berhasil dihapus", Toast.LENGTH_SHORT).show();
                            }
