...
import com.example.siswa.model.Subject;

import java.util.ArrayList;
import java.util.List;

import static com.example.siswa.util.Constants.SUBJECT_CODE;
import static com.example.siswa.util.Constants.SUBJECT_CREDIT;
import static com.example.siswa.util.Constants.SUBJECT_ID;
import static com.example.siswa.util.Constants.SUBJECT_NAME;
import static com.example.siswa.util.Constants.TABLE_SUBJECT;
    ...
    public void createSubject(Subject subject, QueryResponse<Boolean> response) {
        ...
        try {
            ...
            if(id>0) {
                ...
                response.onFailure("Gagal membuat data MatKul!");
    ...
    public void readAllSubject(QueryResponse<List<Subject>> response) {
        ...
        try {
            ...
            if(cursor!=null && cursor.moveToFirst()){
                ...
                response.onFailure("Tidak ada data MatKul di database");
    ...
    public void updateSubject(Subject subject, QueryResponse<Boolean> response) {
        ...
        try {
            ...
            if(rowCount>0)
                ...
                response.onFailure("Tidak ada MatKul yang diperbarui");
    ...
    public void deleteSubject(int subjectId, QueryResponse<Boolean> response) {
        ...
        try {
            ...
            if(rowCount>0)
                ...
                response.onFailure("Tidak ada Matkul yang dihapus");
