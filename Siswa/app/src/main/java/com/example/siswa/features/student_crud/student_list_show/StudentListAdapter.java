package com.example.siswa.features.student_crud.student_list_show;
...
import com.example.siswa.database.*;
import com.example.siswa.features.student_crud.StudentCrudListener;
import com.example.siswa.features.student_crud.student_update.StudentUpdateDialogFragment;
import com.example.siswa.features.taken_subject_crud.taken_subject_show.StudentTakenSubjectActivity;
import com.example.siswa.model.Student;

import java.util.List;

import static com.example.siswa.util.Constants.*;
...
public class StudentListAdapter extends RecyclerView.Adapter<StudentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull StudentViewHolder holder, int position) {
        ...
        holder.editImageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                StudentUpdateDialogFragment dialogFragment = StudentUpdateDialogFragment.newInstance(student, "Update Data Mahasiswa", new StudentCrudListener() {
                    @Override
    ...
    private void showConfirmationDialog(final int studentId) {
        ...
        alertDialogBuilder.setMessage("Ingin menghapus data mahasiswa ini?");
