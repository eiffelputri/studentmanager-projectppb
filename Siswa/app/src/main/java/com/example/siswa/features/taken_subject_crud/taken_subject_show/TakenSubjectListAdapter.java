...
import com.example.siswa.database.QueryContract;
import com.example.siswa.database.QueryResponse;
import com.example.siswa.database.TakenSubjectQueryImplementation;
        ...
        query.deleteTakenSubject(studentId, subjectId, new QueryResponse<Boolean>() {
            ...
            public void onSuccess(Boolean data) {
                if(data){
                    ...
                    Toast.makeText(context, "Gagal menghapus mata kuliah", Toast.LENGTH_LONG).show();
            }
